...
def load_and_prepare():
    ...
    # --- 5. Feature engineering: past-only aggregates per customer ---
    ...
    # --- 6. Final preprocessing: drop IDs, set dtypes ---
    ...
    # Категориальные уже строки с 'Unknown' — переводим в category
